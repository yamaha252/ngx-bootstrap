...
describe('Component: timepicker', () => {
  ...
  describe('validate input fields with property of max', () => {
    ...
    it('should change the input field to specified value if it exceed the specified value 12h', () => {
    ...
    it('should change the input field to specified value if it exceed the specified value 24h', () => {
      component.max = testTime(18);
  ...
  describe('validate input fields with property of min', () => {
    ...
    it('should not value of the input field less the specified value 12h', () => {
    ...
    it('should change the input field to specified value if it less the specified value 24h', () => {
      component.showMeridian = false;
  ...
  describe('custom validate', () => {
    ...
    it('should clear input fields if invalid value', () => {
      component.showSeconds = true;
